...
namespace NerdStore.Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        [Fact(DisplayName = "Atualizar Item Pedido Validar Valor Total")]
        [Trait("Categoria", "Vendas - Pedido")]
        ...
        public void AplicarVoucher_DescontoExcedeValorTotalPedido_PedidoDeveTerValorZero()
        {
            ...
            var voucher = new Voucher("PROMO-300-OFF", null, 300, TipoDescontoVoucher.Valor, 1, DateTime.Now.AddDays(10), true, false);
        ...
        public void AplicarVoucher_ModificarItensPedido_DeveCalcularDescontoValorTotal()
        {
            ...
            var voucher = new Voucher("PROMO-50-OFF", null, 50, TipoDescontoVoucher.Valor, 1, DateTime.Now.AddDays(10), true, false);
            pedido.AplicarVoucher(voucher);
